...
Процедура Печать(ТабДок, Ссылка) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Не Выборка.Сертификаты.Пустой() Тогда
			ТабДок.Вывести(ОбластьСертификатыШапка);
		КонецЕсли;
		
		ВыборкаСертификаты = Выборка.Сертификаты.Выбрать();
		Пока ВыборкаСертификаты.Следующий() Цикл
			ОбластьСертификаты.Параметры.Заполнить(ВыборкаСертификаты);
			ТабДок.Вывести(ОбластьСертификаты, ВыборкаСертификаты.Уровень());
		КонецЦикла;
